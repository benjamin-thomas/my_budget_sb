...
public class AngularController implements ErrorController {
    ...
    public AngularController() throws IOException {
        InputStream indexStream = new ClassPathResource("static/index.html").getInputStream();

        InputStreamReader reader = new InputStreamReader(indexStream);
        this.indexContent = new BufferedReader(reader)
                .lines()
